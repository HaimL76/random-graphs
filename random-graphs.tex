...
\subsection*{4.d}
The following construction shows the number of choices to construct all $2$-factors, along with graphs that are not simple $2$-factors (for instance, graphs that have multiple edges), and hence, the total number of choices that we hereby calculate is an upper bound of the number of choices for $2$-factors.
